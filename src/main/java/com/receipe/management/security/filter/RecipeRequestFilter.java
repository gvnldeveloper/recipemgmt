package com.receipe.management.security.filter;
...
@Component
public class RecipeRequestFilter extends OncePerRequestFilter {

    @Autowired
    private RecipeUserDetailsService jwtUserDetailsService;
    @Autowired
